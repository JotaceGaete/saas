...
const MODULES = [
  ...
  },
  {
    id: 'caja',
    title: 'Caja diaria',
    description: 'Controla pagos reales cobrados desde el TPV.',
    bullets: ['Apertura y cierre', 'Movimientos reales', 'Resumen por metodo'],
    icon: 'Wallet',
  ...
  },
  {
    ...
    description: 'Genera e imprime etiquetas con código de barras EAN-13 en hoja A4 (30×20mm).',
    bullets: ['SKU y código de barras', 'Etiquetas 30×20mm', 'Generador EAN-13 interno'],
    icon: 'Tag',
    iconBg: 'bg-slate-100',
  ...
  },
  {
    id: 'costos',
    title: 'Costos fijos',
    description: 'Registra arriendo, sueldos, servicios y otros costos mensuales recurrentes.',
    bullets: ['Costos fijos mensuales', 'Vinculado al Termómetro', 'Por categoría'],
    icon: 'Building2',
    iconBg: 'bg-blue-100',
    iconColor: 'text-blue-600',
    borderIdle: 'border-gray-200',
  ...
  {
    id: 'informes',
    title: 'Termómetro del negocio',
    description: 'Semáforo financiero mensual: costos, ventas e IVA estimado referencial.',
    bullets: ['Semáforo de rentabilidad', 'IVA neto estimado', 'Mercadería vs gastos'],
    icon: 'BarChart2',
    iconBg: 'bg-indigo-50',
