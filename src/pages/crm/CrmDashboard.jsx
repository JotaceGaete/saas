...
const MODULES = [
  ...
  },
  {
    ...
    description: 'Termómetro financiero mensual: costos, ventas e IVA referencial.',
    bullets: ['Semáforo de rentabilidad', 'Partidas de costo fijo y variable', 'IVA referencial'],
    icon: 'BarChart2',
    iconBg: 'bg-indigo-50',
