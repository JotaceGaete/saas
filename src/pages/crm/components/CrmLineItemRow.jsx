...
export function CrmLineItemTableRow({ item, idx, onChange, onRemove, imageUrl, currency = 'CLP' }) {
  const fmt = (n) => formatMoney(n, currency);
...
// ─── Card — mobile ──────────────────────────────────────────────────────────
export function CrmLineItemCard({ item, idx, onChange, onRemove, imageUrl, currency = 'CLP' }) {
  const fmt = (n) => formatMoney(n, currency);
  const type = item.discount_type || 'percentage';
