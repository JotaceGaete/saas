...
const NEW_BUSINESS_THRESHOLD_MS = 24 * 60 * 60 * 1000;
...
export default function AdminBusinessesPage() {
  ...
  const isNew = (createdAt) => createdAt && (Date.now() - new Date(createdAt).getTime()) < NEW_BUSINESS_THRESHOLD_MS;
          ...
          <section className="mb-6">
            ...
            {loading ? (
              ...
              <>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
                  <div className="px-4 py-4 rounded-xl border" style={{ borderColor: 'var(--color-border)', backgroundColor: 'var(--color-card)' }}>
                    <p className="text-xs font-semibold mb-3" style={{ color: 'var(--color-muted-foreground)', fontFamily: 'var(--font-caption)' }}>Origen · últimos 30d</p>
                                ...
                                <li key={source} className="flex flex-col gap-1">
                                  <div className="flex items-center justify-between gap-2">
                                    <div className="flex items-center gap-1.5 min-w-0">
                                      ...
                                      <span className="text-xs font-medium truncate" style={{ color: 'var(--color-foreground)', fontFamily: 'var(--font-caption)' }}>{getSourceLabel(source)}</span>
                                    </div>
                  ...
                  <div className="px-4 py-4 rounded-xl border" style={{ borderColor: 'var(--color-border)', backgroundColor: 'var(--color-card)' }}>
                    <p className="text-xs font-semibold mb-3" style={{ color: 'var(--color-muted-foreground)', fontFamily: 'var(--font-caption)' }}>Top páginas · últimos 30d</p>
                  ...
                  <div className="px-4 py-4 rounded-xl border" style={{ borderColor: 'var(--color-border)', backgroundColor: 'var(--color-card)' }}>
                    <p className="text-xs font-semibold mb-3" style={{ color: 'var(--color-muted-foreground)', fontFamily: 'var(--font-caption)' }}>Por dominio · últimos 30d</p>
                  ...
                  <table className="w-full text-left" style={{ fontFamily: 'var(--font-caption)' }}>
                    ...
                    <tbody style={{ color: 'var(--color-foreground)' }}>
                      {filteredBusinesses.map(b => {
                        ...
                        const noProducts = (b.totalProducts ?? 0) === 0;
                        return (
                          <tr
                            key={b.id}
                              ...
                              <div className="flex items-center gap-2">
                                <div>
                                  <div className="flex items-center gap-1.5 flex-wrap">
                                    ...
                                    {isNewBiz && (
                                      <span className="text-[10px] font-bold px-1.5 py-0.5 rounded-full" style={{ backgroundColor: 'rgba(16,185,129,0.12)', color: '#059669', fontFamily: 'var(--font-caption)' }}>Nuevo</span>
                                    )}
                                    {noProducts && (
                                      <span className="text-[10px] font-bold px-1.5 py-0.5 rounded-full" style={{ backgroundColor: 'rgba(239,68,68,0.10)', color: '#DC2626', fontFamily: 'var(--font-caption)' }}>Sin productos</span>
                                    )}
                                  </div>
