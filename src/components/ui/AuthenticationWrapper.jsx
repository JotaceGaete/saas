...
const TESTIMONIAL = {
  quote: '"Mis ventas subieron un 40% desde que uso Walinka. Mis clientes pueden ver todo desde su celular."',
  name: 'Mariana López',
      ...
      >
        ...
        <div className="relative z-10">
          ...
          >
            ...
            <span className="font-bold text-white text-lg tracking-tight" style={{ fontFamily: 'var(--font-heading)' }}>Walinka</span>
          </button>
        </div>
      ...
      <div className="flex-1 flex flex-col min-h-screen">
        ...
        <header className="lg:hidden flex items-center justify-between px-5 py-4 border-b" style={{ backgroundColor: '#FFFFFF', borderColor: 'var(--color-border)' }}>
          ...
          >
            ...
            <span className="font-bold text-sm" style={{ fontFamily: 'var(--font-heading)', color: 'var(--color-foreground)' }}>Walinka</span>
          </button>
          {showBackToHome && (
            <button
              onClick={() => navigate('/landing-page')}
