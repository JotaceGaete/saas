 ...
 * go.ventalink.app → país desde selección (localStorage); sin selección → null (nunca forzar un país por defecto).
 */
...
export const COUNTRY_LABELS = Object.freeze({
  ...
  NI: {
    ...
    cityLabel: 'Ciudad',
    cityPlaceholder: 'Ej: Managua, León, Masaya',
    regionLabel: 'Departamento',
    regionPlaceholder: 'Ej: Managua, Granada, Estelí',
    addressPlaceholder: 'Ej: Km 4 Carretera Norte, Casa 12',
    whatsappHint: 'Formato Nicaragua: 8 dígitos. Ej: 8888 7777',
    whatsappErrorPrefix: 'Número móvil Nicaragua',
    testimonialCities: ['Managua', 'León', 'Granada'],
    heroSubtitle: 'Hecho para negocios que venden por WhatsApp en Nicaragua',
    benefitsTitle: 'Hecho para Nicaragua',
    benefitsDescription: 'Precios en NIO, WhatsApp local y soporte en español.',
  },
  EC: {
    countryName: 'Ecuador',
    flag: '🇪🇨',
  ...
  HN: {
    ...
    cityLabel: 'Ciudad',
    cityPlaceholder: 'Ej: Tegucigalpa, San Pedro Sula, La Ceiba',
    regionLabel: 'Departamento',
    regionPlaceholder: 'Ej: Francisco Morazán, Cortés, Atlántida',
    addressPlaceholder: 'Ej: Col. Kennedy, Calle 10, Casa 23',
    whatsappHint: 'Formato Honduras: 8 dígitos. Ej: 9888 7777',
    whatsappErrorPrefix: 'Número móvil Honduras',
    testimonialCities: ['Tegucigalpa', 'San Pedro Sula', 'La Ceiba'],
    heroSubtitle: 'Hecho para negocios que venden por WhatsApp en Honduras',
    benefitsTitle: 'Hecho para Honduras',
    benefitsDescription: 'Precios en HNL, WhatsApp local y soporte en español.',
  },
  SV: {
    ...
    currencyName: 'Dólar estadounidense',
    cityLabel: 'Ciudad',
    cityPlaceholder: 'Ej: San Salvador, Santa Ana, San Miguel',
    regionLabel: 'Departamento',
    regionPlaceholder: 'Ej: San Salvador, Santa Ana, Sonsonate',
    addressPlaceholder: 'Ej: Col. Escalón, 1a Calle Poniente, Casa 12',
    whatsappHint: 'Formato El Salvador: 8 dígitos. Ej: 7888 7777',
    whatsappErrorPrefix: 'Número móvil El Salvador',
    testimonialCities: ['San Salvador', 'Santa Ana', 'San Miguel'],
    heroSubtitle: 'Hecho para negocios que venden por WhatsApp en El Salvador',
    benefitsTitle: 'Hecho para El Salvador',
    benefitsDescription: 'Precios en USD, WhatsApp local y soporte en español.',
  },
  CU: {
    countryName: 'Cuba',
    ...
    cityLabel: 'Ciudad',
    cityPlaceholder: 'Ej: La Habana, Santiago de Cuba, Camagüey',
    regionLabel: 'Provincia',
    regionPlaceholder: 'Ej: La Habana, Santiago de Cuba, Holguín',
    addressPlaceholder: 'Ej: Calle 23 No. 456, Vedado',
    whatsappHint: 'Formato Cuba: 8 dígitos. Ej: 5888 7777',
    whatsappErrorPrefix: 'Número móvil Cuba',
    testimonialCities: ['La Habana', 'Santiago de Cuba', 'Holguín'],
    heroSubtitle: 'Hecho para negocios que venden por WhatsApp en Cuba',
    benefitsTitle: 'Hecho para Cuba',
    benefitsDescription: 'Precios en CUP, WhatsApp local y soporte en español.',
  },
  DO: {
    ...
    cityLabel: 'Ciudad',
    cityPlaceholder: 'Ej: Santo Domingo, Santiago, San Pedro',
    regionLabel: 'Provincia',
    regionPlaceholder: 'Ej: Distrito Nacional, Santiago, La Romana',
    addressPlaceholder: 'Ej: Av. Abraham Lincoln 456, Piso 2',
    whatsappHint: 'Formato R. Dominicana: 10 dígitos (809/829/849 + 7 dígitos). Ej: 809 123 4567',
    whatsappErrorPrefix: 'Número móvil República Dominicana',
    testimonialCities: ['Santo Domingo', 'Santiago', 'San Pedro de Macorís'],
    heroSubtitle: 'Hecho para negocios que venden por WhatsApp en República Dominicana',
    benefitsTitle: 'Hecho para RD',
    benefitsDescription: 'Precios en DOP, WhatsApp local y soporte en español.',
  },
  PR: {
    ...
    currencyName: 'Dólar estadounidense',
    cityLabel: 'Ciudad',
    cityPlaceholder: 'Ej: San Juan, Bayamón, Ponce',
    regionLabel: 'Municipio',
    regionPlaceholder: 'Ej: San Juan, Bayamón, Carolina',
    addressPlaceholder: 'Ej: Calle San Francisco 456, Old San Juan',
    whatsappHint: 'Formato Puerto Rico: 10 dígitos (787/939 + 7 dígitos). Ej: 787 123 4567',
    whatsappErrorPrefix: 'Número móvil Puerto Rico',
    testimonialCities: ['San Juan', 'Bayamón', 'Ponce'],
    heroSubtitle: 'Hecho para negocios que venden por WhatsApp en Puerto Rico',
    benefitsTitle: 'Hecho para Puerto Rico',
    benefitsDescription: 'Precios en USD, WhatsApp local y soporte en español.',
  },
  VE: {
    ...
    cityLabel: 'Ciudad',
    cityPlaceholder: 'Ej: Caracas, Maracaibo, Valencia',
    regionLabel: 'Estado',
    regionPlaceholder: 'Ej: Miranda, Zulia, Carabobo',
    addressPlaceholder: 'Ej: Av. Francisco de Miranda, Torre 1, Piso 3',
    whatsappHint: 'Formato Venezuela: 10 dígitos (0412/0414/0424/0416/0426). Ej: 0412 123 4567',
    whatsappErrorPrefix: 'Número móvil Venezuela',
    testimonialCities: ['Caracas', 'Maracaibo', 'Valencia'],
    heroSubtitle: 'Hecho para negocios que venden por WhatsApp en Venezuela',
    benefitsTitle: 'Hecho para Venezuela',
    benefitsDescription: 'Precios en Bs.D, WhatsApp local y soporte en español.',
  },
  PA: {
    countryName: 'Panamá',
    flag: '🇵🇦',
